...
@Operation(
        ...
        <strong>Accesible solo para usuarios con rol ADMIN.</strong>
        """,
...
@ApiResponses(value = {
        @ApiResponse(
                responseCode = "200",
                description = "Almacenes encontrados exitosamente",
                content = @Content(
        ...
        @ApiResponse(
                        ...
                        schema = @Schema(example = """
                {
                  ...
                  "errorCode": "FORBIDDEN",
                  "details": "El usuario no tiene permisos para buscar almacenes",
                  "path": "/api/warehouses/search"
                }
                """)
                )
        ),
...
public @interface SearchWarehousesEndpointDoc {
}
