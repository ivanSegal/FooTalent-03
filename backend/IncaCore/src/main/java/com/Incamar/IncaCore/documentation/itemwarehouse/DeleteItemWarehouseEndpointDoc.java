...
@Documented
@Operation(
        summary = "Eliminar ítem de almacén",
        description = """
        Elimina un ítem de un almacén por su ID único. \
...
@ApiResponses(value = {
        @ApiResponse(
                responseCode = "200",
                description = "Ítem de almacén eliminado exitosamente",
                content = @Content(
                        mediaType = "application/json",
                        schema = @Schema(example = """
                {
                  "success": true,
                  "message": "Item de almacen eliminado exitosamente.",
                  "data": null
                }
                """)
                )
        ...
        @ApiResponse(
                ...
                content = @Content(
                        ...
                        schema = @Schema(example = """
                        {
                          ...
                          "errorCode": "FORBIDDEN",
                          "details": "El usuario no tiene permisos para eliminar este ítem de almacén",
...
public @interface DeleteItemWarehouseEndpointDoc {
}
