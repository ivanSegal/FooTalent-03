...
@Documented
@Operation(
        summary = "Buscar actividades por id de orden de mantenimiento con paginación",
        description = """
        Retorna una lista paginada de actividades cuyo id de orden de matnenimiento coincida . \s
...
public @interface SearchActivitiesByMaintenanceOrderIdEndpointDoc {}
